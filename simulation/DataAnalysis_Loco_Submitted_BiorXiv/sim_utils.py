...
default_running_pct_cutoff = 0.1 # This should be 0.4
...
def gen_rs(dsnames=None,selection=None,dcutoff=5,pval_cutoff=0.05,slices=None,running=True,fill_nans_under_cutoff=True,running_pct_cutoff=default_running_pct_cutoff,expttype='size_contrast_0'):
    ...
    tunings,uparams,displacements,pvals =  compute_tunings(dsnames,running=running,expttype=expttype,running_pct_cutoff=default_running_pct_cutoff,fill_nans_under_cutoff=True)
